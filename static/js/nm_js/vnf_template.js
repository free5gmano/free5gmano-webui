    ...
    for (var i = 0; i < response.data.attributeListOut.length; i++) {
      document.getElementById("nssitable").innerHTML += '\
        <tr>\
          ...
          <td align="center"><a href="/GetNSSItopology?id='+response.data.attributeListOut[i].nssiId+'"><img src="images/topology_icon.png" alt="" style="width: 32px; height: 32px"></a></td>\
        </tr>';
    }
